...
const Footer = () => {
    return (
        <section className="py-20 bg-gray-900 sm:pt-16 lg:pt-24">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        {/* <video controls autoPlay muted loop className='appearance-none w-1/5'>
            ...
            <p className="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2021, All Rights Reserved by Career-Hub</p>
        </div>
    </div>
</section>
