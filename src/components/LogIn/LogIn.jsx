                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    <div className="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
                        <div className="absolute inset-0">
                            <img className="object-cover object-top w-full h-full" src="https://i.ibb.co/LvF2Ycg/animated9.gif" alt="" />
                        </div>
                        <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent"></div>

                        <div className="relative">
                            <div className="w-full max-w-xl xl:w-full xl:mx-auto xl:pr-24 xl:max-w-xl">
                                <h3 className="text-4xl font-bold text-white"> <br className="hidden xl:block" />Unlocking Your  Potential can be a click away! – Log in to Your Journey!</h3>
                    ...
                    <div className="flex items-center justify-center px-4 py-10 bg-white dark:bg-gray-900 sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                        <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                            <h2 className="text-3xl font-bold leading-tight dark:text-white text-black sm:text-4xl">Sign in</h2>
                            <p className="mt-2 text-base text-gray-600 dark:text-white">Don’t have an account? <Link to="/register" className="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">Create a free account</Link></p>
