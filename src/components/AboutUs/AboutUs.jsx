            ...
            <div className="flex flex-wrap ">
                <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                    <div className="lg:max-w-md">
                        ...
                        Build Your Future. Build Your Dream. Join, Work And Succeed!
                        <br />
                        Career-HUB has hired more than 3500 people and filled hundreds of companies with employees since 2010. It's our goal to help individual reach their best potential and achieve success.
                        </p>
                ...
                <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                    <img src="https://i.postimg.cc/9MW8G96J/pexels-the-coach-space-2977565.jpg" alt=""
                        className="relative z-0 object-cover w-full h-full rounded"/>
                </div>
            </div>
        </div>
    </section>
